...
class ActionHandler extends AbstractActionHandler { // made for the hackathon... at block.one they use postgres
  ...
  async handleWithState (handle) { // NEED TO IMPLEMENT THIS METHOD
    const context = { socket: io.getSocket() }
    const state = { post: Post, blockIndexState: BlockIndexState } // this the state interface {Post is mongoo model obj}
    try {
